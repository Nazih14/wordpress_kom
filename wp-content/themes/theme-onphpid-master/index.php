...
<div class="jumbotron" style="background-color: #fff; border: none; padding-top: 0px; padding-bottom: 60px; margin-bottom: 0px;">
        ...
        <div class="row">
          <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
            <div class="site-heading" >
              <h3 style="color: #fff; text-align: center;"><?php bloginfo('name');?></h3>
              <hr class="small">
            </div>
          </div>
        </div>
    ...
    <div class="row">
     ...
     <div id="thumbnail-slider">
      <div class="inner">
        <ul>
          <li>
            <a class="thumb" href="<?php echo get_template_directory_uri() .'/img/home-bg.jpg';?>" />
        ...
        <li>
          <a class="thumb" href="<?php echo get_template_directory_uri() .'/img/home-bg.jpg';?>"></a>
          <div class="carousel-caption">
            <a href="<?php the_permalink();?>">
              <h2>
               <?php the_title();?>
